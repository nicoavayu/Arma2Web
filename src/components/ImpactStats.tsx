      ...
      <div className="container mx-auto">
            ...
            <div className="grid gap-5 md:grid-cols-[1.1fr_1fr] md:items-center">
              <div>
                <div className="mb-3 inline-flex items-center gap-2 rounded-full border border-white/15 bg-white/5 px-3 py-1 text-[11px] font-semibold uppercase tracking-[0.18em] text-white/75">
                  ...
                  {t.impact.activityBadge}
                </div>
                <h3 className="mb-2 text-xl font-bold text-white md:text-2xl">{t.impact.activityTitle}</h3>
                <p className="text-sm leading-relaxed text-text-secondary md:text-base">
                  {t.impact.activityDescription}
                </p>
              </div>

              <div className="grid grid-cols-3 gap-2.5">
                {t.impact.annualMetrics.map((metric) => (
        ...
        >
          <div className="flex items-center gap-2 text-primary-glow">
            ...
            <span className="text-xs font-bold uppercase tracking-[0.2em]">{t.impact.recurring.eyebrow}</span>
          </div>
          <p className="max-w-2xl text-sm text-text-secondary">
            {t.impact.recurring.description}
          </p>
        </motion.div>
      </div>
    </Section>
