                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                    ...
                    <div className="order-1 md:order-1 relative h-[48vh] min-h-[320px] max-h-[420px] md:h-[600px] flex items-center justify-center mt-6 mb-1 [@media(max-height:700px)]:mb-4 md:mt-0 md:mb-0">
                        ...
                        <motion.div
                            ...
                            className="relative w-full max-w-[320px] md:max-w-none md:w-full h-full flex items-center justify-center md:justify-end md:translate-x-0 md:-translate-y-2 z-10 scale-[1.4] [@media(max-height:700px)]:scale-[1.6] md:scale-[1.65]"
                        >
