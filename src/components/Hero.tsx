...
export function Hero() {
    return (
        <Section id="home" className="relative h-[100svh] min-h-[100svh] md:h-auto md:min-h-screen flex items-center pt-24 md:pt-20 pb-[calc(2rem+env(safe-area-inset-bottom))] md:pb-12 overflow-y-auto overflow-x-hidden md:overflow-hidden">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                    ...
                    <div className="flex flex-col items-center text-center md:items-start md:text-left order-2 md:order-2 relative z-20">
                        ...
                        <motion.h1
                            ...
                            className="text-[32px] md:text-7xl font-bold tracking-tight text-white mb-1 md:mb-4 leading-[1.1] md:leading-tight"
                        >
